...
{
    UIButton *btn = [UIButton buttonWithType:UIButtonTypeCustom];
    [btn setImage:[UIImage JSenImageNamed:name] forState:UIControlStateNormal];
    [btn setImage:[UIImage JSenImageNamed:selectImgName] forState:UIControlStateHighlighted];
    btn.frame = frame;
