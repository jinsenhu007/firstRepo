...
#define kCancelButtonHeight   40  //我在下面已经去掉cancelButton 这里设置为0
...
-(void)show
{
	...
	UIImageView *alertBgImage = [[UIImageView alloc] initWithImage:[[UIImage JSenImageNamed:@"MLTableAlertBackground.png"] stretchableImageWithLeftCapWidth:15 topCapHeight:30]];
	...
	UIImageView *maskShadow = [[UIImageView alloc] initWithImage:[[UIImage JSenImageNamed:@"MLTableAlertShadowMask.png"] stretchableImageWithLeftCapWidth:6 topCapHeight:7]];
	...
	[self.cancelButton setBackgroundImage:[[UIImage JSenImageNamed:@"MLTableAlertButton.png"] stretchableImageWithLeftCapWidth:5 topCapHeight:0] forState:UIControlStateNormal];
	[self.cancelButton setBackgroundImage:[[UIImage JSenImageNamed:@"MLTableAlertButtonPressed.png"] stretchableImageWithLeftCapWidth:5 topCapHeight:0] forState:UIControlStateHighlighted];
	...
	[self.alertBg addSubview:self.cancelButton];////--------去掉了取消按钮--------
